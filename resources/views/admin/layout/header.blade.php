...
<!--Page Wrapper -->
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Data Penerima Warga -->
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#warga" aria-expanded="true" aria-controls="collapse') }}">
          <i class="fas fa-fw fa-download"></i>
          <span>Data Warga</span>
        </a>
        <div id="warga" class="collapse" aria-labelledby="warga" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="{{ asset('admin/warga') }}"><i class="fa fa-newspaper"></i> Data Warga</a>
            <a class="collapse-item" href="{{ asset('admin/warga/tambah') }}"><i class="fa fa-plus"></i> Tambah Data</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="download" class="collapse" aria-labelledby="download" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="{{ asset('admin/bantuan') }}"><i class="fa fa-newspaper"></i> Data Penerima Bantuan</a>
            <a class="collapse-item" href="{{ asset('admin/bantuan/tambah') }}"><i class="fa fa-plus"></i> Tambah Data</a>
            <a class="collapse-item" href="{{ asset('admin/kategori_bantuan') }}"><i class="fa fa-tags"></i> RT/RW</a>
          </div>
        </div>
      </li>
      <!-- Galeri -->
